...
The training data preparation workflow can be divided into five steps:
  ...
  4) **Create different types of training data:** Randomly missing along the cross line direction, Trace-wice missing, and regular missing. We chose the missing ratios ranging from 20% to 95% in the randomly missing. For the regular missing data, we randomly select strides from (2,2) to (8,8).
